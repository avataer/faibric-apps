...
const Navigation = ({ currentView, onNavigate }) => {
  ...
  const navItems = [{"id": "home", "label": "Home"}, {"id": "services", "label": "Services"}, {"id": "about", "label": "About Us"}, {"id": "contact", "label": "Contact"}];

  return (
    <nav className="bg-white shadow-md sticky top-0 z-50">
      <div className="max-w-7xl mx-auto px-4">
        <div className="flex justify-between items-center h-16">
          <span className="text-xl font-bold text-gray-900">Test Solutions</span>
    ...
    >
      ...
      <div className="relative z-10 text-center text-white px-4 max-w-4xl">
        ...
        <p className="text-xl md:text-2xl mb-8 opacity-90">
          We deliver comprehensive testing and quality assurance services that ensure your products meet the highest standards every time.
        </p>
        <button
    ...
    <footer className="bg-gray-900 text-white py-12">
      <div className="max-w-6xl mx-auto px-4">
        <div className="text-center">
          <h3 className="text-2xl font-bold mb-2">Test Solutions</h3>
          <p className="text-gray-400 mb-6">Setting the standard in quality assurance and testing excellence.</p>
          <div className="border-t border-gray-800 pt-6">
            <p className="text-gray-500 text-sm">
              2024 Test Solutions. All rights reserved.
            </p>
...
const FAIBRIC_SESSION_TOKEN = "vf0YOPSl6jDx0OjlSgKX8M6BSlbA22y3MVML-pvuM5Y";
