...
const HeroSection = ({ onNavigate }) => {
  ...
  return (
    <section className="min-h-screen bg-gradient-to-b from-amber-100 to-orange-100 py-20">
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
          {(cards || []).map((card, index) => (
            ...
            >
              <div className="w-16 h-16 bg-gradient-to-br from-amber-600 to-amber-900 rounded-2xl flex items-center justify-center mb-6 group-hover:scale-110 transition-transform">
        ...
        <div className="grid md:grid-cols-2 gap-12">
          <div>
            <div className="flex items-center gap-3 mb-8">
              <div className="w-12 h-12 bg-gradient-to-br from-amber-600 to-amber-900 rounded-xl flex items-center justify-center">
