  ...
  return (
    <section className="min-h-screen bg-gradient-to-b from-amber-100 to-amber-50 py-20">
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="mb-16 rounded-2xl overflow-hidden shadow-2xl border border-amber-200">
            ...
            <div className="absolute inset-0 bg-gradient-to-t from-amber-900/70 via-amber-900/30 to-transparent flex items-end">
              <div className="p-8 md:p-12">
                ...
                <button
                  ...
                  className="mt-4 bg-amber-700 hover:bg-amber-800 text-amber-50 font-semibold py-3 px-6 rounded-xl transition-colors"
                >
                  Visit Us Today
                </button>
              </div>
  ...
  return (
    <section className="min-h-screen bg-gradient-to-b from-amber-100 to-amber-50 py-20">
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="mb-12 rounded-2xl overflow-hidden shadow-xl border border-amber-200">
          <img
            src="https://picsum.photos/seed/coffee-latte"
        ...
        <div className="grid md:grid-cols-2 gap-12">
          <div>
            <div className="flex items-center gap-3 mb-8">
              <div className="w-12 h-12 bg-gradient-to-br from-amber-700 to-amber-900 rounded-xl flex items-center justify-center">
        ...
        <div className="text-center mt-12">
          <button
            ...
            className="bg-amber-700 hover:bg-amber-800 text-amber-50 font-semibold py-3 px-8 rounded-xl transition-colors text-lg"
          >
            View Brunch Menu →
          </button>
        </div>
