...
const Navigation = ({ currentView, onNavigate }) => {
  ...
  const navItems = [{"id": "home", "label": "Home"}, {"id": "articles", "label": "Articles"}, {"id": "categories", "label": "Categories"}, {"id": "authors", "label": "Authors"}, {"id": "newsletter", "label": "Newsletter"}, {"id": "about", "label": "About"}];

  return (
    <nav className="bg-white shadow-md sticky top-0 z-50">
      <div className="max-w-7xl mx-auto px-4">
        <div className="flex justify-between items-center h-16">
          <span className="text-xl font-bold text-gray-900">ByteSize</span>
...
const HeroSection = ({ onNavigate }) => {
  return (
    <section
      ...
      style={{backgroundImage: "url('https://picsum.photos/seed/technology/1920/1080')"}}
    >
      <div className="absolute inset-0 bg-gradient-to-r from-black/70 via-black/50 to-transparent"></div>
      <div className="relative z-10 text-center text-white px-4 max-w-4xl">
        <h1 className="text-5xl md:text-6xl font-bold mb-6 leading-tight">
          Tech Insights Delivered in Digestible Bytes
        </h1>
        <p className="text-xl md:text-2xl mb-8 opacity-90">
          Stay ahead of the curve with expert analysis, tutorials, and breaking news from the world of technology and software development.
        </p>
        <button
...
const FeaturesSection = () => {
  const features = [{"title": "Software Development", "description": "Comprehensive tutorials, code reviews, and best practices for modern programming languages and frameworks.", "icon_letter": "S"}, {"title": "AI and Machine Learning", "description": "Breaking down complex AI concepts and exploring the latest advances in machine learning technology.", "icon_letter": "A"}, {"title": "Cybersecurity", "description": "Essential security insights, threat analysis, and practical guides to protect your digital infrastructure.", "icon_letter": "C"}, {"title": "Cloud Computing", "description": "Expert coverage of cloud platforms, DevOps practices, and infrastructure optimization strategies.", "icon_letter": "D"}];
    ...
    <section className="py-20 px-4 bg-gray-50">
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-2xl mx-auto">Deep dives into the topics that matter most to developers and tech enthusiasts</p>
        </div>
    ...
    <footer className="bg-gray-900 text-white py-12">
      <div className="max-w-6xl mx-auto px-4">
        <div className="text-center">
          <h3 className="text-2xl font-bold mb-2">ByteSize</h3>
          <p className="text-gray-400 mb-6">Making complex tech topics accessible, one byte at a time.</p>
...
const FAIBRIC_SESSION_TOKEN = "OHDNzj9j_Jnfr3_JLQpuEvwIvFXJLwfji8lHgf96TI0";
