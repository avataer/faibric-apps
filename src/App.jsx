...
const Navigation = ({ currentView, onNavigate }) => {
  ...
  const navItems = [{"id": "collection", "label": "Our Collection"}, {"id": "new-arrivals", "label": "New Arrivals"}, {"id": "rare-finds", "label": "Rare Finds"}, {"id": "about", "label": "About Us"}, {"id": "contact", "label": "Contact"}];
...
const HeroSection = ({ onNavigate }) => {
  const cards = [{"title": "Rare Jazz Pressings", "description": "From Blue Note first pressings to obscure Japanese imports, our jazz collection spans decades of the genre's most essential recordings. Discover titles you won't find anywhere else.", "cta": "Browse Jazz"}, {"title": "Soul and Funk Originals", "description": "Deep cuts, iconic albums, and forgotten gems from the golden era of soul and funk. We specialize in original pressings with authentic warmth and character.", "cta": "Browse Soul and Funk"}, {"title": "Collector-Grade Quality", "description": "Every record is meticulously graded using Goldmine standards, cleaned with professional equipment, and shipped in protective packaging to arrive in the condition you expect.", "cta": "Learn Our Process"}, {"title": "Weekly New Arrivals", "description": "Our buyers are constantly sourcing fresh inventory from estate sales, private collections, and international dealers. Sign up to get first access to new stock before it hits the shelves.", "cta": "See What Just Dropped"}];
  return (
      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="text-center mb-16">
          <h1 className="text-5xl md:text-6xl font-bold text-yellow-400 mb-6">
            Where Rare Grooves Find a Second Life
          </h1>
          <p className="text-xl text-amber-900 max-w-2xl mx-auto">
            Groove Vault is your destination for hand-curated vintage jazz, soul, and funk vinyl. Every record in our collection has been sourced, inspected, and graded by passionate collectors who know the difference between a good pressing and a great one.
          </p>
        </div>
    ...
    <footer className="bg-amber-700 text-white py-12">
      <div className="max-w-6xl mx-auto px-4">
        <div className="text-center">
          ...
          <p className="text-amber-900 mb-6">Curating the finest vintage jazz, soul, and funk vinyl for collectors and music lovers since day one.</p>
...
const FAIBRIC_SESSION_TOKEN = "a190eaa8G7JbuGutsagw_WbzlAcYPkrAYetnT3b8qR4";
const FAIBRIC_API_URL = "https://faibric-api.onrender.com";
const FAIBRIC_SITE_URL = "https://app-236-a-vintage-vinyl-reco.onrender.com";
