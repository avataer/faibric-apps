...
const Navigation = ({ currentView, onNavigate }) => {
  ...
  const navItems = [{"id": "home", "label": "Home"}, {"id": "services", "label": "Services"}, {"id": "how-it-works", "label": "How It Works"}, {"id": "contact", "label": "Contact"}];

  return (
    <nav className="bg-white shadow-md sticky top-0 z-50">
      <div className="max-w-7xl mx-auto px-4">
        <div className="flex justify-between items-center h-16">
          <span className="text-xl font-bold text-gray-900">Pipeline Verify</span>
    ...
    >
      ...
      <div className="relative z-10 text-center text-white px-4 max-w-4xl">
        <h1 className="text-5xl md:text-6xl font-bold mb-6 leading-tight">
          Reliable API Pipeline Testing You Can Trust
        </h1>
        <p className="text-xl md:text-2xl mb-8 opacity-90">
          We ensure your API integrations perform flawlessly from development through production with comprehensive verification solutions.
        </p>
        <button
    ...
    <footer className="bg-gray-900 text-white py-12">
      <div className="max-w-6xl mx-auto px-4">
        <div className="text-center">
          <h3 className="text-2xl font-bold mb-2">Pipeline Verify</h3>
          <p className="text-gray-400 mb-6">Ensuring seamless API pipeline performance at every stage of delivery.</p>
          <div className="border-t border-gray-800 pt-6">
            <p className="text-gray-500 text-sm">
              2024 Pipeline Verify. All rights reserved.
            </p>
...
const FAIBRIC_SESSION_TOKEN = "cbbc9fbd1c9f239413c42545850ddc494601dadcbd66001388658a4a9122d0da";
