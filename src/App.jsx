...
const LayoutApp = ({
 ...
 return (
 <div className={`min-h-screen flex flex-col bg-gray-900 text-white ${className}`}>
...
const Navigation = ({ 
 ...
 return (
 <nav className="bg-gray-900 text-white p-4 rounded-lg shadow-md max-w-xs mx-auto">
 <div className="flex flex-col items-center space-y-4">
 <h2 className="text-lg font-semibold">Simple Counter</h2>
...
const FormSection = () => {
 ...
 <p className="text-6xl font-bold text-gray-100">{count}</p>
 </div>
 <div className="flex justify-center gap-4">
 <button 
 onClick={handleDecrement}
 className="
 bg-red-700 text-white px-6 py-3 rounded-lg 
