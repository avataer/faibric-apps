  ...
  return (
    <section className="min-h-screen relative flex items-center justify-center overflow-hidden">
      <div
        ...
        style={{
          backgroundImage: "url('https://picsum.photos/seed/peaceful yoga practice in sunlit studio with green plants and natural light/1920/1080')",
      ...
      <div className="relative z-10 text-center text-white px-6 max-w-4xl">
        ...
        <h1 className="text-5xl md:text-7xl font-bold mb-6 leading-tight">
          Find Your Flow. Discover Your Peace.
        </h1>
        <p className="text-xl md:text-2xl mb-10 opacity-90 max-w-2xl mx-auto">
          Zen Flow Studio offers thoughtfully guided yoga classes in a serene, nature-inspired space. Whether you are a beginner seeking stillness or an experienced practitioner deepening your practice, our studio is your sanctuary.
        </p>
...
const FeaturesSection = () => {
  const features = [{"title": "Nature-Inspired Studio Space", "description": "Our studio is filled with natural light, living greenery, and sustainably sourced materials. Every class feels like stepping into a peaceful garden retreat, helping you disconnect from the noise of daily life.", "icon_letter": "N"}, {"title": "Expert-Led Classes for Every Level", "description": "From gentle restorative sessions to challenging vinyasa flows, our certified instructors tailor each class to meet you where you are. Personalized guidance ensures safe alignment and meaningful progress.", "icon_letter": "E"}, {"title": "Small Class Sizes", "description": "We intentionally keep our classes intimate with a maximum of 15 students. This means more individual attention from your instructor and a deeper, more connected practice every time you step on the mat.", "icon_letter": "S"}, {"title": "Holistic Wellness Community", "description": "Beyond the mat, Zen Flow Studio hosts monthly workshops, meditation circles, and wellness events. Join a supportive community that nurtures your physical, mental, and spiritual well-being year-round.", "icon_letter": "H"}];
    ...
    <section className="py-20 px-4 bg-gray-50">
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-2xl mx-auto">At Zen Flow Studio, every detail is designed to support your journey toward balance, strength, and inner calm.</p>
        </div>
...
const AboutSection = () => {
  const paragraphs = ["Zen Flow Studio was founded in 2019 with a simple intention: to create a space where people could slow down, breathe deeply, and reconnect with themselves. Nestled in the heart of the city, our studio was designed as an urban oasis, blending minimalist architecture with the warmth of the natural world.", "Our founder, Maya Chen, spent over a decade studying yoga traditions across India, Bali, and Costa Rica before bringing her vision to life. She believed that a truly transformative yoga practice begins with the environment, and every element of Zen Flow Studio reflects that philosophy, from our bamboo flooring to our living moss walls.", "Today, our team of dedicated instructors carries forward that founding vision. We offer over 30 classes per week spanning Hatha, Vinyasa, Yin, Restorative, and Prenatal yoga. Whether you visit us at sunrise for a morning flow or unwind with an evening meditation, you will always find a welcoming space that feels like home.", "We are more than a studio. We are a community rooted in mindfulness, compassion, and the belief that everyone deserves a moment of peace in their day."];
      ...
      <div className="max-w-6xl mx-auto">
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          <div className="relative">
            ...
            <img
              src="https://picsum.photos/seed/serene yoga studio interior with green plants bamboo floors and natural sunlight streaming through large windows/800/600"
              alt="About us"
    ...
    <section className="py-20 px-4 bg-gray-50">
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600">Have questions about our classes, memberships, or private sessions? We would love to hear from you. Reach out and a member of our team will respond within 24 hours.</p>
        </div>
            ...
            <div>
              ...
              <div className="space-y-4 text-gray-600">
                ...
                <p className="flex items-center gap-3">
                  ...
                  742 Evergreen Lane, Suite 200, San Francisco, CA 94110
                </p>
              </div>
            </div>
          </div>
    ...
    <footer className="bg-gray-900 text-white py-12">
      <div className="max-w-6xl mx-auto px-4">
        <div className="text-center">
          ...
          <p className="text-gray-400 mb-6">Breathe deeply. Move mindfully. Live peacefully.</p>
