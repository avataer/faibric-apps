  ...
  return (
    <section className="min-h-screen relative flex items-center justify-center overflow-hidden">
      <div
        ...
        style={{
          backgroundImage: "url('https://picsum.photos/seed/peaceful green forest with sunlight filtering through leaves yoga meditation nature/1920/1080')",
...
const FeaturesSection = () => {
  const features = [{"title": "Yoga Classes", "description": "From gentle Hatha to dynamic Vinyasa, our yoga classes are tailored for every level. Build strength, improve flexibility, and cultivate mindfulness through intentional movement and breath.", "icon_letter": "Y"}, {"title": "Pilates Sessions", "description": "Strengthen your core, align your posture, and enhance total-body control with our mat and reformer Pilates classes. Perfect for athletes and beginners alike.", "icon_letter": "P"}, {"title": "Guided Meditation", "description": "Step away from the noise. Our meditation sessions offer breathwork, visualization, and mindfulness techniques to help you find deep stillness and lasting clarity.", "icon_letter": "M"}, {"title": "Private Instruction", "description": "Work one-on-one with our certified instructors for personalized guidance. Whether you are recovering from injury or deepening your practice, private sessions are designed around you.", "icon_letter": "I"}];
    ...
    <section className="py-20 px-4 bg-gray-50">
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-2xl mx-auto">Three pathways to wellness, each guided by expert instructors in our tranquil emerald-toned studio.</p>
        </div>
...
const AboutSection = () => {
  const paragraphs = ["Zen Flow Studio was founded with a simple belief: that everyone deserves a peaceful place to reconnect with themselves. Nestled in the heart of the community, our studio draws inspiration from the natural world, with emerald tones, living greenery, and open light creating an atmosphere that feels like stepping into a forest clearing.", "Our team of experienced, certified instructors brings decades of combined practice in yoga, pilates, and meditation. Every class is thoughtfully designed to meet you where you are, whether you are stepping onto the mat for the first time or have been practicing for years.", "At Zen Flow, we are more than a studio. We are a community rooted in kindness, growth, and the shared pursuit of well-being. We invite you to breathe deeply, move freely, and discover the calm that lives within you."];
      ...
      <div className="max-w-6xl mx-auto">
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          <div className="relative">
            ...
            <img
              src="https://picsum.photos/seed/serene yoga studio interior with green plants natural light white walls peaceful atmosphere/800/600"
              alt="About us"
    ...
    <section className="py-20 px-4 bg-gray-50">
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600">Have questions about our classes, pricing, or schedule? We would love to hear from you. Fill out the form below or reach us directly.</p>
        </div>
            ...
            <div>
              ...
              <div className="space-y-4 text-gray-600">
                ...
                <p className="flex items-center gap-3">
                  ...
                  142 Evergreen Lane, Suite 200, Portland, OR 97205
                </p>
              </div>
            </div>
          </div>
    ...
    <footer className="bg-gray-900 text-white py-12">
      <div className="max-w-6xl mx-auto px-4">
        <div className="text-center">
          ...
          <p className="text-gray-400 mb-6">Breathe deeply. Move freely. Live fully.</p>
...
const FAIBRIC_SESSION_TOKEN = "NeqirXe8wGxbJ8tZHdXqp0Wl25_T2rBoOSviZzDLnsQ";
