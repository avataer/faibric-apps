...
const Navigation = ({ currentView, onNavigate }) => {
  ...
  const navItems = [{"id": "features", "label": "Features"}, {"id": "pricing", "label": "Pricing"}, {"id": "about", "label": "About"}, {"id": "testimonials", "label": "Testimonials"}, {"id": "contact", "label": "Get Started"}];
...
const HeroSection = ({ onNavigate }) => {
  return (
    <section
      ...
      style={{backgroundImage: "url('https://picsum.photos/seed/cloud-technology/1920/1080')"}}
    >
      <div className="absolute inset-0 bg-gradient-to-r from-black/70 via-black/50 to-transparent"></div>
      <div className="relative z-10 text-center text-white px-4 max-w-4xl">
        <h1 className="text-5xl md:text-6xl font-bold mb-6 leading-tight">
          Your Files, Protected and Synced Everywhere
        </h1>
        <p className="text-xl md:text-2xl mb-8 opacity-90">
          Automatic cloud backup that keeps your data safe, accessible, and synchronized across all your devices in real-time.
        </p>
        <button
...
const FeaturesSection = () => {
  const features = [{"title": "Real-Time Sync", "description": "Changes are instantly backed up and synchronized across all connected devices with zero lag or manual intervention.", "icon_letter": "S"}, {"title": "Military-Grade Encryption", "description": "Your data is protected with AES-256 encryption both in transit and at rest, ensuring complete privacy and security.", "icon_letter": "E"}, {"title": "Version History", "description": "Access up to 180 days of file versions. Recover deleted files or restore previous versions with a single click.", "icon_letter": "V"}, {"title": "Smart Bandwidth", "description": "Intelligent upload scheduling and bandwidth throttling ensures backups never interfere with your productivity.", "icon_letter": "B"}];

  return (
    <section className="py-20 px-4 bg-gray-50">
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-16">
          <h2 className="text-4xl font-bold text-gray-900 mb-4">Why Choose CloudSync</h2>
          <p className="text-xl text-gray-600 max-w-2xl mx-auto">Enterprise-grade backup technology made simple for teams of all sizes</p>
        </div>
...
const ServicesSection = () => {
  const services = [{"name": "Starter", "description": "Perfect for individuals. 100GB storage, 2 devices, 30-day version history, email support.", "price": "$5/month"}, {"name": "Professional", "description": "Ideal for freelancers. 1TB storage, 5 devices, 90-day version history, priority support, file sharing.", "price": "$12/month"}, {"name": "Business", "description": "Built for teams. 5TB storage, unlimited devices, 180-day version history, admin console, SSO integration.", "price": "$29/user/month"}, {"name": "Enterprise", "description": "Custom solutions with unlimited storage, dedicated account manager, custom retention policies, and SLA guarantees.", "price": "Contact us"}];
...
const AboutSection = () => {
  const paragraphs = ["Founded in 2019, CloudSync was born from a simple frustration: existing backup solutions were either too complex for everyday users or too basic for professional needs. We set out to build something different.", "Our team of security engineers and cloud architects has created a platform that combines enterprise-level protection with consumer-friendly simplicity. Today, over 50,000 businesses trust CloudSync to protect their most valuable digital assets.", "Headquartered in San Francisco with data centers across North America, Europe, and Asia-Pacific, we ensure your data is always close, fast, and compliant with regional regulations."];
    ...
    <section className="py-20 px-4">
      <div className="max-w-6xl mx-auto">
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div>
            <h2 className="text-4xl font-bold text-gray-900 mb-8">About CloudSync</h2>
          ...
          <div className="relative">
            ...
            <img
              src="https://picsum.photos/seed/data-center-servers/800/600"
              alt="About us"
...
const TestimonialsSection = () => {
  const testimonials = [{"quote": "CloudSync saved us when a ransomware attack hit our network. We restored three months of work in under an hour. The peace of mind alone is worth every penny.", "name": "Sarah Mitchell", "role": "IT Director, Apex Marketing"}, {"quote": "We evaluated six different backup solutions before choosing CloudSync. The combination of speed, security, and ease of use was unmatched. Setup took less than 15 minutes.", "name": "David Chen", "role": "CTO, Brightwave Studios"}, {"quote": "As a photographer, my files are my livelihood. CloudSync handles terabytes of RAW files without breaking a sweat. The version history has saved me from accidental overwrites countless times.", "name": "Maria Gonzalez", "role": "Professional Photographer"}, {"quote": "The admin dashboard gives me complete visibility into our backup status across 200 employees. Compliance reporting that used to take days now takes minutes.", "name": "James Okonkwo", "role": "Security Manager, FinServ Partners"}];

  return (
    <section className="py-20 px-4 bg-gradient-to-br from-slate-900 to-slate-800">
      <div className="max-w-6xl mx-auto">
        <h2 className="text-4xl font-bold text-center text-white mb-16">Trusted by Teams Worldwide</h2>
...
const ContactSection = () => {
  ...
  return (
    <section className="py-20 px-4 bg-gray-50">
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-16">
          <h2 className="text-4xl font-bold text-gray-900 mb-4">Ready to Protect Your Data?</h2>
          <p className="text-xl text-gray-600">Start your 14-day free trial today. No credit card required.</p>
        </div>
            ...
            <div>
              ...
              <div className="space-y-4 text-gray-600">
                ...
                <p className="flex items-center gap-3">
                  ...
                  548 Market Street, Suite 400, San Francisco, CA 94104
                </p>
              </div>
            </div>
          </div>
    ...
    <footer className="bg-gray-900 text-white py-12">
      <div className="max-w-6xl mx-auto px-4">
        <div className="text-center">
          <h3 className="text-2xl font-bold mb-2">CloudSync</h3>
          <p className="text-gray-400 mb-6">Secure backup and sync for modern teams</p>
...
const FAIBRIC_SESSION_TOKEN = "p6JDgtxVUsYy64LP8Ma3thhe2Dp4J0WWvogF3zO-pGY";
