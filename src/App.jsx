  ...
  return (
    <section className="min-h-screen relative flex items-center justify-center overflow-hidden">
      <div
        ...
        style={{
          backgroundImage: "url('https://picsum.photos/seed/peaceful yoga practice in sunlit studio with green plants/1920/1080')",
      ...
      <div className="relative z-10 text-center text-white px-6 max-w-4xl">
        ...
        <p className="text-xl md:text-2xl mb-10 opacity-90 max-w-2xl mx-auto">
          Zen Flow Studio is a peaceful sanctuary where mindful movement meets nature-inspired tranquility. Join our welcoming community and nurture your body, mind, and spirit through the transformative practice of yoga.
        </p>
...
const FeaturesSection = () => {
  const features = [{"title": "Nature-Inspired Space", "description": "Our studio is filled with natural light, living greenery, and bamboo accents that create a serene environment where you can truly disconnect from the outside world and reconnect with yourself.", "icon_letter": "N"}, {"title": "Expert-Led Classes", "description": "Our certified instructors bring years of dedicated practice and training to every session, offering personalized guidance for students of all levels from complete beginners to advanced practitioners.", "icon_letter": "E"}, {"title": "Holistic Approach", "description": "We go beyond physical postures to incorporate breathwork, meditation, and mindfulness techniques that support lasting well-being and a deeper connection to your authentic self.", "icon_letter": "H"}, {"title": "Inclusive Community", "description": "Whether you are stepping onto the mat for the first time or deepening a lifelong practice, our supportive community welcomes every body, every background, and every intention.", "icon_letter": "I"}];
    ...
    <section className="py-20 px-4 bg-gray-50">
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-2xl mx-auto">At Zen Flow Studio, every detail is designed to support your journey toward inner peace and physical well-being.</p>
        </div>
...
const AboutSection = () => {
  const paragraphs = ["Zen Flow Studio was founded with a simple yet powerful vision: to create a space where the ancient wisdom of yoga meets the beauty of the natural world. Nestled in a light-filled studio adorned with living plants and organic materials, we offer a refuge from the pace of modern life.", "Our founder, inspired by years of studying yoga traditions across India and Southeast Asia, envisioned a studio that would feel less like a gym and more like a garden. Every element of our space, from the reclaimed wood floors to the soft green tones on our walls, is intentionally chosen to evoke calm and presence.", "Today, Zen Flow Studio serves a vibrant community of practitioners who share a commitment to mindful living. We offer a diverse range of classes including Vinyasa Flow, Restorative Yoga, Yin Yoga, and guided meditation, all taught by compassionate instructors who are dedicated to helping you grow both on and off the mat.", "We believe that yoga is not about perfection. It is about showing up, breathing deeply, and honoring where you are in this moment. We invite you to come as you are and leave feeling more connected, centered, and alive."];
      ...
      <div className="max-w-6xl mx-auto">
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          <div className="relative">
            ...
            <img
              src="https://picsum.photos/seed/tranquil yoga studio interior with green plants natural light bamboo/800/600"
              alt="About us"
            ...
            <div>
              ...
              <div className="space-y-4 text-gray-600">
                ...
                <p className="flex items-center gap-3">
                  ...
                  742 Willow Creek Lane, Suite 101, San Francisco, CA 94110
                </p>
              </div>
            </div>
          </div>
