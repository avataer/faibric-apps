...
const HeroSection = ({ onNavigate }) => {
  const cards = [{"title": "Freshly Roasted Daily", "description": "Our beans are roasted every morning in-house, ensuring the richest and most aromatic cup of coffee you have ever tasted.", "cta": "See Our Menu"}, {"title": "Cozy Atmosphere", "description": "Warm lighting, comfortable seating, and the inviting aroma of fresh coffee make The Roasted Bean the perfect place to relax or get work done.", "cta": "Visit Us Today"}, {"title": "Pastries and Bites", "description": "Pair your favorite brew with our selection of freshly baked pastries, sandwiches, and seasonal treats made by local bakers.", "cta": "Explore the Menu"}];
  return (
      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-2xl mx-auto">
            Handcrafted coffee made from ethically sourced beans, roasted in small batches and brewed with care. Welcome to your new favorite neighborhood coffee shop.
          </p>
        </div>
...
const FeaturesSection = () => {
  const features = [{"title": "Single-Origin Beans", "description": "We source our coffee directly from farmers in Colombia, Ethiopia, and Guatemala, paying fair prices and ensuring exceptional quality in every bag.", "icon_letter": "B"}, {"title": "Expert Baristas", "description": "Our team of trained baristas are passionate about the craft. From pour-overs to latte art, every drink is prepared with precision and pride.", "icon_letter": "E"}, {"title": "Community First", "description": "We host weekly open mic nights, art showcases, and coffee tasting events. The Roasted Bean is more than a cafe, it is a gathering place.", "icon_letter": "C"}, {"title": "Sustainable Practices", "description": "From compostable cups to energy-efficient roasting equipment, we are committed to reducing our environmental footprint one cup at a time.", "icon_letter": "S"}];

  return (
    <section className="py-20 px-4 bg-gray-50">
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-16">
          <h2 className="text-4xl font-bold text-gray-900 mb-4">Why Choose The Roasted Bean</h2>
          <p className="text-xl text-gray-600 max-w-2xl mx-auto">We go beyond just serving coffee. Here is what sets us apart from the rest.</p>
        </div>
...
const AboutSection = () => {
  const paragraphs = ["The Roasted Bean was born out of a simple love for great coffee and meaningful connections. Founded in 2018 by lifelong friends Sarah and Marcus, our shop started as a small corner space with a single espresso machine and a dream to bring truly exceptional coffee to the neighborhood.", "Over the years, we have grown into a beloved community hub where friends catch up over cappuccinos, students study beside sun-filled windows, and professionals find their morning inspiration. Every detail of our space, from the reclaimed wood tables to the warm ambient lighting, has been designed to make you feel at home.", "We believe that coffee is more than a beverage. It is a ritual, a conversation starter, and a moment of calm in a busy world. That is why we take the time to source the finest beans, roast them with care, and serve them with a genuine smile. Thank you for being part of our story."];
    ...
    <section className="py-20 px-4 bg-gray-50">
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600">Whether you have a question, want to book our space for a private event, or just want to share your favorite coffee order, we would love to hear from you.</p>
        </div>
            ...
            <div>
              ...
              <div className="space-y-4 text-gray-600">
                ...
                <p className="flex items-center gap-3">
                  ...
                  247 Maple Street, Suite 1, Brooklyn, NY 11201
                </p>
              </div>
            </div>
          </div>
    ...
    <footer className="bg-gray-900 text-white py-12">
      <div className="max-w-6xl mx-auto px-4">
        <div className="text-center">
          ...
          <p className="text-gray-400 mb-6">Handcrafted coffee, roasted with passion, served with heart.</p>
