  ...
  return (
    <section className="min-h-screen relative flex items-center justify-center overflow-hidden">
      <div
        ...
        style={{
          backgroundImage: "url('https://picsum.photos/seed/peaceful green forest canopy with sunlight filtering through leaves nature calm/1920/1080')",
    ...
    <section className="py-20 px-4 bg-gray-50">
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-2xl mx-auto">Three pathways to balance your body, mind, and spirit — all under one roof.</p>
        </div>
      ...
      <div className="max-w-6xl mx-auto">
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          <div className="relative">
            ...
            <img
              src="https://picsum.photos/seed/serene yoga studio interior with green plants natural wood floors soft white walls peaceful atmosphere/800/600"
              alt="About us"
    ...
    <section className="py-20 px-4 bg-gray-50">
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600">Have a question about our classes, pricing, or studio? We would love to hear from you. Fill out the form below or reach us directly — our team typically responds within 24 hours.</p>
        </div>
            ...
            <div>
              ...
              <div className="space-y-4 text-gray-600">
                ...
                <p className="flex items-center gap-3">
                  ...
                  142 Evergreen Lane, Suite 3, San Francisco, CA 94110
                </p>
              </div>
            </div>
          </div>
...
const FAIBRIC_SESSION_TOKEN = "OTxbIYSKCyQ1H1vzpqOkPk_o51585CZNcrHtq4RijPE";
