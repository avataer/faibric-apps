...
const HeroSection = ({ onNavigate }) => {
  const cards = [{"title": "Freshly Roasted Beans", "description": "We source single-origin beans from sustainable farms around the world and roast them weekly in our own micro-roastery.", "cta": "Explore Our Beans"}, {"title": "Handcrafted Drinks", "description": "From velvety lattes to bold pour-overs, every drink is crafted by skilled baristas who take pride in perfection.", "cta": "See the Menu"}, {"title": "A Space to Gather", "description": "Whether you need a quiet corner to work or a warm table for conversation, our shop is your second home.", "cta": "Plan Your Visit"}];
  return (
      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-2xl mx-auto">
            Specialty coffee roasted in small batches, brewed with care, and served in a space designed for connection. Welcome to Ember & Bloom.
          </p>
        </div>
...
const FeaturesSection = () => {
  const features = [{"title": "Small-Batch Roasting", "description": "Every bag of beans is roasted on-site in batches of 15 pounds or less, ensuring peak freshness and a flavor profile that is never stale or mass-produced.", "icon_letter": "R"}, {"title": "Ethically Sourced", "description": "We partner directly with farming cooperatives in Colombia, Ethiopia, and Guatemala, paying fair prices and supporting sustainable agriculture.", "icon_letter": "E"}, {"title": "Expert Baristas", "description": "Our team trains extensively in extraction science, latte art, and flavor profiling so that every cup we serve meets our exacting standards.", "icon_letter": "B"}, {"title": "Community First", "description": "From hosting local art shows to offering free meeting space for neighborhood groups, we are committed to being more than just a coffee shop.", "icon_letter": "C"}];
    ...
    <section className="py-20 px-4 bg-gray-50">
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-2xl mx-auto">We believe great coffee is about more than just the drink. It is about the experience from the first aroma to the last sip.</p>
        </div>
...
const AboutSection = () => {
  const paragraphs = ["Ember & Bloom Coffee was born from a simple idea: that a neighborhood deserves a coffee shop that cares as much about community as it does about quality. Founded in 2019 by two lifelong friends with a passion for specialty coffee, we set out to create a space where every detail matters.", "What started as a small counter with a single espresso machine has grown into a beloved gathering place. We built our own micro-roastery so we could control every step of the process, from sourcing green beans to dialing in the perfect roast profile. The result is coffee that is distinctly ours.", "Today, we serve hundreds of customers each week, but we have never lost sight of what matters most: genuine hospitality, exceptional coffee, and a warm atmosphere that makes everyone feel welcome. Whether you are a seasoned coffee connoisseur or simply looking for your morning cup, there is a place for you here."];
      ...
      <div className="max-w-6xl mx-auto">
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          <div className="relative">
            ...
            <img
              src="https://picsum.photos/seed/cozy-coffee-shop-interior-warm-lighting-wooden-tables/800/600"
              alt="About us"
    ...
    <section className="py-20 px-4 bg-gray-50">
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600">We would love to hear from you. Stop by the shop, give us a call, or send us a message. We are always happy to chat about coffee, catering, or private events.</p>
        </div>
            ...
            <div>
              ...
              <div className="space-y-4 text-gray-600">
                ...
                <p className="flex items-center gap-3">
                  ...
                  247 Oak Street, Austin, TX 78701
                </p>
              </div>
            </div>
          </div>
    ...
    <footer className="bg-gray-900 text-white py-12">
      <div className="max-w-6xl mx-auto px-4">
        <div className="text-center">
          ...
          <p className="text-gray-400 mb-6">Small-batch coffee, big-hearted community. Roasted and served with care since 2019.</p>
...
const FAIBRIC_SESSION_TOKEN = "8bGnx6la_atuMTeY_yUxXSSnMlJNVnORDcV6_ZWZ8eM";
