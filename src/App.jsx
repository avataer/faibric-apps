    ...
    <section className="min-h-screen relative flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 text-center text-white px-6 max-w-4xl">
        ...
        <p className="text-xl md:text-2xl mb-10 opacity-90 max-w-2xl mx-auto">
          Welcome to Zen Flow Studio, where mindful movement meets nature-inspired tranquility. Join our community of practitioners and experience yoga that nurtures your body, calms your mind, and restores your spirit.
        </p>
...
const FeaturesSection = () => {
  const features = [{"title": "Nature-Inspired Space", "description": "Our studio is filled with natural light, living greenery, and sustainable materials that create a calming sanctuary away from the noise of everyday life.", "icon_letter": "N"}, {"title": "Expert-Led Classes", "description": "Our certified instructors bring years of dedicated practice and training, offering personalized guidance whether you are a complete beginner or an advanced practitioner.", "icon_letter": "E"}, {"title": "Holistic Approach", "description": "We go beyond physical postures to integrate breathwork, meditation, and mindfulness techniques that promote lasting well-being in every aspect of your life.", "icon_letter": "H"}, {"title": "Inclusive Community", "description": "Every body is a yoga body. Our welcoming community embraces all ages, abilities, and experience levels with compassion, respect, and encouragement.", "icon_letter": "I"}];
    ...
    <section className="py-20 px-4 bg-gray-50">
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-2xl mx-auto">At Zen Flow Studio, every detail is designed to support your wellness journey in a serene, welcoming environment.</p>
        </div>
...
const AboutSection = () => {
  const paragraphs = ["Zen Flow Studio was founded with a simple vision: to create a peaceful refuge where people can reconnect with themselves through the transformative practice of yoga. Nestled in a light-filled space surrounded by greenery, our studio embodies the harmony between movement and stillness.", "Our team of passionate instructors draws from diverse yoga traditions, including Vinyasa, Hatha, Yin, and Restorative practices. Each class is thoughtfully crafted to guide you through sequences that build strength, increase flexibility, and cultivate inner peace.", "We believe that yoga is more than a workout. It is a lifelong practice of self-discovery. Whether you step onto the mat for the first time or have been practicing for decades, Zen Flow Studio is your home for growth, healing, and authentic connection."];
      ...
      <div className="max-w-6xl mx-auto">
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          <div className="relative">
            ...
            <img
              src="https://picsum.photos/seed/serene yoga studio interior with green plants natural light bamboo/800/600"
              alt="About us"
            ...
            <div>
              ...
              <div className="space-y-4 text-gray-600">
                ...
                <p className="flex items-center gap-3">
                  ...
                  142 Willow Creek Lane, Suite 200, Portland, OR 97205
                </p>
              </div>
            </div>
          </div>
