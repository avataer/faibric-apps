  ...
  return (
    <section className="min-h-screen relative flex items-center justify-center overflow-hidden">
      <div
        ...
        style={{
          backgroundImage: "url('https://picsum.photos/seed/peaceful yoga studio with green plants and natural light/1920/1080')",
      ...
      <div className="relative z-10 text-center text-white px-6 max-w-4xl">
        ...
        <p className="text-xl md:text-2xl mb-10 opacity-90 max-w-2xl mx-auto">
          Zen Flow Studio offers thoughtfully designed yoga classes for every level, guiding you toward balance, strength, and inner peace in a serene, welcoming space.
        </p>
...
const FeaturesSection = () => {
  const features = [{"title": "Classes for Every Level", "description": "From gentle restorative sessions to challenging vinyasa flows, our diverse schedule ensures there is a perfect class for beginners and seasoned practitioners alike.", "icon_letter": "C"}, {"title": "Expert-Led Instruction", "description": "Our certified instructors bring years of dedicated training and a passion for teaching, offering personalized guidance and hands-on adjustments to deepen your practice safely.", "icon_letter": "E"}, {"title": "Calm, Intentional Space", "description": "Our studio is designed with natural materials, soft lighting, and lush greenery to create an atmosphere that invites relaxation the moment you walk through the door.", "icon_letter": "S"}, {"title": "Community and Connection", "description": "Join a supportive community of like-minded individuals who share your commitment to wellness. We host workshops, retreats, and social gatherings throughout the year.", "icon_letter": "H"}];
    ...
    <section className="py-20 px-4 bg-gray-50">
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-2xl mx-auto">We have created a sanctuary where mindful movement meets modern wellness, so you can step off the mat feeling renewed.</p>
        </div>
...
const AboutSection = () => {
  const paragraphs = ["Zen Flow Studio was founded in 2019 with a simple mission: to create a space where people can slow down, breathe deeply, and reconnect with themselves. What began as a small community class in a rented room has grown into a beloved studio that serves hundreds of practitioners each week.", "Our founder, Maya Chen, envisioned a yoga studio that felt like a living sanctuary, where the calming presence of nature merged seamlessly with the practice. Every detail of our space, from the bamboo flooring to the living plant walls, was chosen to cultivate tranquility and focus.", "Today, our team of four dedicated instructors offers over 25 classes per week, spanning vinyasa, hatha, yin, restorative, and prenatal yoga. Whether you are stepping onto the mat for the first time or refining a decades-long practice, Zen Flow Studio is your home for growth, healing, and community."];
      ...
      <div className="max-w-6xl mx-auto">
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          <div className="relative">
            ...
            <img
              src="https://picsum.photos/seed/serene yoga studio interior with green plants white walls and natural wood/800/600"
              alt="About us"
    ...
    <section className="py-20 px-4 bg-gray-50">
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600">Have questions about our classes, pricing, or private sessions? Reach out and our team will get back to you within 24 hours.</p>
        </div>
            ...
            <div>
              ...
              <div className="space-y-4 text-gray-600">
                ...
                <p className="flex items-center gap-3">
                  ...
                  742 Willow Lane, Suite 110, San Francisco, CA 94102
                </p>
              </div>
            </div>
          </div>
    ...
    <footer className="bg-gray-900 text-white py-12">
      <div className="max-w-6xl mx-auto px-4">
        <div className="text-center">
          ...
          <p className="text-gray-400 mb-6">Breathe. Move. Transform.</p>
...
const FAIBRIC_SESSION_TOKEN = "cbfd276b12e81bd41e90e75ee3adc48b5ecd2a9bcac39afbc040bcfb950d20e5";
