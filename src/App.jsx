...
const Navigation = ({ currentView, onNavigate }) => {
  ...
  const navItems = [{"id": "home", "label": "Home"}, {"id": "about", "label": "About Us"}, {"id": "features", "label": "Our Classes"}, {"id": "schedule", "label": "Schedule"}, {"id": "pricing", "label": "Pricing"}, {"id": "contact", "label": "Contact"}];
  ...
  return (
    <section className="min-h-screen relative flex items-center justify-center overflow-hidden">
      <div
        ...
        style={{
          backgroundImage: "url('https://picsum.photos/seed/peaceful yoga practice in a sunlit studio surrounded by green plants and natural light/1920/1080')",
      ...
      <div className="relative z-10 text-center text-white px-6 max-w-4xl">
        ...
        <h1 className="text-5xl md:text-7xl font-bold mb-6 leading-tight">
          Find Your Balance. Discover Your Flow.
        </h1>
        <p className="text-xl md:text-2xl mb-10 opacity-90 max-w-2xl mx-auto">
          Welcome to Zen Flow Studio, a tranquil sanctuary where breath meets movement. Step onto the mat, release the noise of everyday life, and reconnect with the stillness within. Our experienced instructors guide you through mindful practices designed to restore your body, calm your mind, and nourish your spirit.
        </p>
...
const FeaturesSection = () => {
  const features = [{"title": "Vinyasa Flow", "description": "A dynamic, breath-synchronized practice that links movement with intention. Build strength, flexibility, and endurance as you flow through creative sequences that leave you feeling energized and centered.", "icon_letter": "V"}, {"title": "Restorative Yoga", "description": "Slow down and surrender into deeply supported postures held for extended periods. This gentle, meditative practice activates your parasympathetic nervous system, promoting deep healing and profound relaxation.", "icon_letter": "R"}, {"title": "Morning Meditation", "description": "Start your day with clarity and calm. Our guided meditation sessions combine breathwork, visualization, and mindfulness techniques to cultivate inner peace that carries you through the entire day.", "icon_letter": "M"}, {"title": "Power Yoga", "description": "Challenge yourself with an athletic, fitness-focused practice that builds core strength and stamina. This vigorous class is perfect for those seeking a physically demanding workout rooted in yogic tradition.", "icon_letter": "P"}];

  return (
    <section className="py-20 px-4 bg-gray-50">
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-16">
          <h2 className="text-4xl font-bold text-gray-900 mb-4">Classes Designed for Every Body</h2>
          <p className="text-xl text-gray-600 max-w-2xl mx-auto">Whether you are a complete beginner or a seasoned practitioner, our diverse class offerings meet you exactly where you are on your yoga journey.</p>
        </div>
...
const AboutSection = () => {
  const paragraphs = ["Zen Flow Studio was founded in 2018 with a simple vision: to create a welcoming, nature-inspired space where people from all walks of life can experience the transformative power of yoga. Nestled in the heart of downtown, our studio is designed to feel like stepping into a living garden, with abundant natural light, living plants, and a calming palette that soothes the senses the moment you walk through our doors.", "Our team of certified instructors brings over 40 combined years of teaching experience across multiple yoga traditions, including Hatha, Vinyasa, Yin, and Kundalini. Each instructor is dedicated to creating an inclusive, judgment-free environment where every student feels supported, challenged, and inspired to grow.", "At Zen Flow Studio, we believe yoga is more than a physical practice. It is a pathway to greater self-awareness, emotional resilience, and genuine well-being. We are honored to walk this path alongside our vibrant community of practitioners, and we invite you to join us on the mat."];
      ...
      <div className="max-w-6xl mx-auto">
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          <div className="relative">
            ...
            <img
              src="https://picsum.photos/seed/serene yoga studio interior with green plants natural wood floors and soft natural light streaming through large windows/800/600"
              alt="About us"
    ...
    <section className="py-20 px-4 bg-gray-50">
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600">Have questions about our classes, pricing, or studio? We would love to hear from you. Reach out below and a member of our team will respond within 24 hours.</p>
        </div>
            ...
            <div>
              ...
              <div className="space-y-4 text-gray-600">
                ...
                <p className="flex items-center gap-3">
                  ...
                  247 Willow Creek Lane, Suite 102, Portland, OR 97205
                </p>
              </div>
            </div>
          </div>
    ...
    <footer className="bg-gray-900 text-white py-12">
      <div className="max-w-6xl mx-auto px-4">
        <div className="text-center">
          ...
          <p className="text-gray-400 mb-6">Breathe deeply. Move mindfully. Live fully.</p>
...
const FAIBRIC_SESSION_TOKEN = "a295936c55393e3cd4b025d54331c963e50e241cb5b29089250239a5dac10899";
