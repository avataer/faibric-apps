    ...
    <nav className="bg-white shadow-md sticky top-0 z-50">
      <div className="max-w-7xl mx-auto px-4">
        <div className="flex justify-between items-center h-16">
          <span className="text-xl font-bold text-gray-900">Alex Chen Photography</span>
    ...
    <section className="min-h-screen flex items-center justify-center bg-white">
      <div className="max-w-4xl mx-auto px-6 py-24 text-center">
        ...
        <p className="text-xl md:text-2xl text-gray-500 mb-12 max-w-2xl mx-auto font-light">
          Award-winning photographer specializing in portraits, editorial, and fine art photography. Based in San Francisco, available worldwide.
        </p>
        <button
...
const FeaturesSection = () => {
  const features = [{"title": "Portrait Photography", "description": "Authentic, expressive portraits for individuals, couples, and families. From studio sessions to on-location shoots, every frame is crafted to reveal who you truly are.", "icon_letter": "P"}, {"title": "Editorial & Commercial", "description": "Polished imagery for brands, magazines, and campaigns. I collaborate closely with creative teams to deliver visuals that elevate your brand identity and resonate with your audience.", "icon_letter": "E"}, {"title": "Fine Art Prints", "description": "Limited-edition fine art prints available for collectors and interior designers. Each piece is archival-quality, printed on museum-grade paper and ready to transform any space.", "icon_letter": "F"}, {"title": "Event Documentation", "description": "Discreet, thoughtful coverage of private events, galas, and milestone celebrations. I focus on candid storytelling so you can relive every meaningful detail.", "icon_letter": "D"}];
    ...
    <section className="py-20 px-4 bg-gray-50">
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-2xl mx-auto">Every project is approached with intention, artistry, and a deep respect for the moment.</p>
        </div>
...
const AboutSection = () => {
  const paragraphs = ["Alex Chen is a San Francisco-based photographer whose work lives at the intersection of light, emotion, and narrative. With over a decade behind the lens, Alex has built a reputation for imagery that feels both timeless and deeply personal.", "After studying visual arts at the Rhode Island School of Design, Alex honed his craft assisting renowned photographers in New York before returning to the West Coast to launch his own practice. His work has been featured in Vogue, National Geographic, and The New York Times.", "Whether shooting a quiet portrait in natural window light or a large-scale commercial campaign, Alex brings the same philosophy to every project: listen first, observe carefully, and let the story unfold. The result is work that connects on a human level and stands the test of time.", "When not shooting, Alex leads photography workshops, mentors emerging artists, and explores the California coastline in search of the next perfect frame."];
    ...
    <section className="py-20 px-4">
      <div className="max-w-6xl mx-auto">
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div>
            <h2 className="text-4xl font-bold text-gray-900 mb-8">About Alex</h2>
          ...
          <div className="relative">
            ...
            <img
              src="https://picsum.photos/seed/photographer-portrait-studio/800/600"
              alt="About us"
    ...
    <section className="py-20 px-4 bg-gray-50">
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600">Have a project in mind or want to discuss a collaboration? I would love to hear from you. Fill out the form below or reach out directly.</p>
        </div>
            ...
            <div>
              ...
              <div className="space-y-4 text-gray-600">
                ...
                <p className="flex items-center gap-3">
                  ...
                  Studio 204, 1355 Market Street, San Francisco, CA 94103
                </p>
              </div>
            </div>
          </div>
    ...
    <footer className="bg-gray-900 text-white py-12">
      <div className="max-w-6xl mx-auto px-4">
        <div className="text-center">
          <h3 className="text-2xl font-bold mb-2">Alex Chen Photography</h3>
          <p className="text-gray-400 mb-6">Light. Emotion. Story.</p>
          <div className="border-t border-gray-800 pt-6">
            <p className="text-gray-500 text-sm">
              2024 Alex Chen Photography. All rights reserved.
            </p>
...
const FAIBRIC_SESSION_TOKEN = "4jLBjxYvNDdo75F6SLSf0NHRUEyFbnEp01CKboQUk1A";
