    ...
    <nav className="bg-white shadow-md sticky top-0 z-50">
      <div className="max-w-7xl mx-auto px-4">
        <div className="flex justify-between items-center h-16">
          <span className="text-xl font-bold text-gray-900">Lens & Shadow</span>
    ...
    <section className="py-20 px-4 bg-gray-50">
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-2xl mx-auto">Every project is approached with intention, artistry, and a commitment to delivering images that resonate long after the moment has passed.</p>
        </div>
    ...
    <section className="py-20 px-4">
      <div className="max-w-6xl mx-auto">
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div>
            <h2 className="text-4xl font-bold text-gray-900 mb-8">The Photographer Behind the Lens</h2>
...
const ContactSection = () => {
  ...
  return (
    <section className="py-20 px-4 bg-gray-50">
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-16">
          <h2 className="text-4xl font-bold text-gray-900 mb-4">Let's Create Something Together</h2>
          <p className="text-xl text-gray-600">Whether you have a project in mind or simply want to explore possibilities, I would love to hear from you. Reach out and let's start a conversation.</p>
        </div>
    ...
    <footer className="bg-gray-900 text-white py-12">
      <div className="max-w-6xl mx-auto px-4">
        <div className="text-center">
          ...
          <p className="text-gray-400 mb-6">Fine art and editorial photography rooted in light, emotion, and story.</p>
          <div className="border-t border-gray-800 pt-6">
            <p className="text-gray-500 text-sm">
              2024 Lens & Shadow. All rights reserved.
            </p>
...
const FAIBRIC_SESSION_TOKEN = "D0qgikPPPGfjzp54EN_afzPfqcYB8RYRtYS6w6Syvm8";
