...
const Navigation = ({ currentView, onNavigate }) => {
  ...
  const navItems = [{"id": "home", "label": "Home"}, {"id": "menu", "label": "Our Menu"}, {"id": "about", "label": "Our Story"}, {"id": "features", "label": "Why Us"}, {"id": "contact", "label": "Visit Us"}];

  return (
    <nav className="bg-white shadow-md sticky top-0 z-50">
      <div className="max-w-7xl mx-auto px-4">
        <div className="flex justify-between items-center h-16">
          <span className="text-xl font-bold text-gray-900">Ember & Bloom Coffee</span>
...
const HeroSection = ({ onNavigate }) => {
  const cards = [{"title": "Signature Espresso Drinks", "description": "Explore our curated menu of espresso-based creations, from classic cappuccinos to our house-favorite Ember Mocha with dark chocolate and smoked vanilla.", "cta": "View Our Menu"}, {"title": "Fresh-Baked Pastries Daily", "description": "Every morning, our kitchen turns out buttery croissants, seasonal scones, and artisan breakfast sandwiches made with locally sourced ingredients.", "cta": "See Today's Selection"}, {"title": "Catering & Events", "description": "Let us bring the Ember & Bloom experience to your office, wedding, or private gathering with our full-service coffee catering packages.", "cta": "Book Your Event"}];
  return (
      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-2xl mx-auto">
            Specialty coffee, handcrafted with care. From single-origin pour-overs to rich, velvety lattes, Ember & Bloom is your neighborhood destination for exceptional coffee and warm community.
          </p>
        </div>
...
const FeaturesSection = () => {
  const features = [{"title": "Ethically Sourced Beans", "description": "We partner directly with small-farm cooperatives in Colombia, Ethiopia, and Guatemala, ensuring fair wages and sustainable growing practices for every harvest.", "icon_letter": "E"}, {"title": "Roasted In-House Weekly", "description": "Our beans are roasted in small batches right here in our roastery every week, guaranteeing peak freshness and flavor in every cup we serve.", "icon_letter": "R"}, {"title": "Expert Baristas", "description": "Our team undergoes rigorous training in extraction science, latte art, and flavor profiling so your drink is crafted to perfection every single time.", "icon_letter": "B"}, {"title": "Community First", "description": "From hosting local artists and musicians to supporting neighborhood nonprofits, we are deeply invested in making our community a better place to live.", "icon_letter": "C"}];
    ...
    <section className="py-20 px-4 bg-gray-50">
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-2xl mx-auto">At Ember & Bloom, we believe great coffee comes from intention at every step, from sourcing to serving.</p>
        </div>
...
const AboutSection = () => {
  const paragraphs = ["Ember & Bloom Coffee was born in 2018 from a simple belief: that a great cup of coffee has the power to transform an ordinary moment into something meaningful. What started as a small pop-up at the local farmers market quickly grew into a beloved neighborhood gathering place.", "Our founders, Maya and Jordan, spent two years traveling through coffee-growing regions across Central and South America, learning the craft from the farmers themselves. That journey shaped everything about how we source, roast, and serve our coffee today.", "Today, Ember & Bloom is more than a coffee shop. It is a place where freelancers find their focus, friends reconnect over a warm latte, and neighbors become family. We take pride in knowing our regulars by name and their orders by heart.", "We are committed to sustainability at every level, from compostable packaging and oat milk at no extra charge to our zero-waste initiative that diverts 95 percent of our waste from landfills. Great coffee should be good for people and the planet."];
      ...
      <div className="max-w-6xl mx-auto">
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          <div className="relative">
            ...
            <img
              src="https://picsum.photos/seed/cozy artisan coffee shop interior with warm lighting and exposed brick/800/600"
              alt="About us"
...
const ContactSection = () => {
  ...
  return (
    <section className="py-20 px-4 bg-gray-50">
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-16">
          <h2 className="text-4xl font-bold text-gray-900 mb-4">Come Say Hello</h2>
          <p className="text-xl text-gray-600">Whether you have a question about our menu, want to book a catering event, or simply want to share your favorite brew, we would love to hear from you.</p>
        </div>
            ...
            <div>
              ...
              <div className="space-y-4 text-gray-600">
                ...
                <p className="flex items-center gap-3">
                  ...
                  247 Magnolia Street, Austin, TX 78702
                </p>
              </div>
            </div>
          </div>
    ...
    <footer className="bg-gray-900 text-white py-12">
      <div className="max-w-6xl mx-auto px-4">
        <div className="text-center">
          <h3 className="text-2xl font-bold mb-2">Ember & Bloom Coffee</h3>
          <p className="text-gray-400 mb-6">Specialty coffee roasted with intention, served with heart.</p>
          <div className="border-t border-gray-800 pt-6">
            <p className="text-gray-500 text-sm">
              2024 Ember & Bloom Coffee. All rights reserved.
            </p>
