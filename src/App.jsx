...
const LayoutApp = ({
 ...
 title: "Family Law",
 description: "Compassionate legal support for complex family matters."
 },
 {
 ...
 {/* Hero Section */}
 <section 
 className="min-h-[70vh] bg-cover bg-center flex items-center justify-center text-white"
 ...
 <h1 className="text-5xl font-bold mb-4">Experienced Legal Representation</h1>
 <p className="text-xl mb-8">Protecting Your Rights, Pursuing Justice</p>
 <button className="bg-indigo-600 hover:bg-indigo-700 px-8 py-3 rounded-lg transition-colors">
 Free Consultation
 </button>
 </div>
 </section>
 ...
 >
 {area.icon}
 <h3 className="text-xl font-semibold mt-4 mb-2">{area.title}</h3>
 ...
 <p>&copy; 2023 Johnson Legal Group. All Rights Reserved.</p>
 </div>
 </footer>
 </div>
 );
...
const Navigation = ({
 logo,
 logoText = "Justice Advocates LLP",
 navItems = [
 ...
 <header
 className={`
 w-full bg-white shadow-md z-50 transition-all duration-300
 ...
 <a
 href={ctaButton.href}
 className="inline-flex items-center px-6 py-3 border border-transparent text-sm font-semibold rounded-lg text-white bg-indigo-600 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 transition-all duration-200 shadow-md hover:shadow-xl"
 >
 {ctaButton.label}
 </a>
 </div>
...
const Card = () => {
 ...
 {
 title: "Personal Injury",
 description: "Aggressive representation for accident and injury victims",
 icon: null
 },
 {
 title: "Family Law",
 description: "Compassionate legal support for divorce and custody matters",
 icon: null
 },
 {
 title: "Business Law",
 description: "Strategic legal counsel for business challenges and transactions",
 icon: null
 },
 {
 title: "Estate Planning",
 ...
 <div className="text-2xl font-bold text-indigo-600">Justice Legal Group</div>
 <div className="flex space-x-6">
 <button 
 onClick={() => handleNavigate("home")} 
 ...
 type="tel" 
 placeholder="Phone Number" 
 className="w-full p-3 border border-slate-300 rounded-lg mt-6"
 required 
 />
 <textarea 
 placeholder="Your Message" 
 className="w-full p-3 border border-slate-300 rounded-lg mt-6 h-32"
 required
 />
 <button 
 type="submit"
 className="w-full bg-indigo-600 hover:bg-indigo-700 text-white font-semibold py-3 rounded-lg mt-6 transition-all"
 >
 Send Message
 </button>
 </form>
...
const ListView = () => {
 ...
 Experienced legal representation for complex legal challenges
 </p>
 <button className="bg-indigo-600 hover:bg-indigo-700 text-white font-semibold py-3 px-8 rounded-lg transition-all">
 Schedule Consultation
 </button>
 </div>
 </header>
 ...
 <footer className="bg-gray-900 text-white py-12">
 <div className="container mx-auto px-4 text-center">
 <p>&copy; 2024 Pinnacle Legal Group. All Rights Reserved.</p>
 </div>
 </footer>
 </div>
 );
...
const FormSection = () => {
 ...
 // Define contact form fields for law firm
 const contactFields = [
 {
 name: "name",
 label: "Full Name",
 ...
 {
 name: "message",
 label: "Legal Consultation Request",
 type: "textarea",
 ...
 // Handle form submission for law firm consultation
 const handleContactSubmit = async (values) => {
 setIsSubmitting(true);
 setSubmitSuccess(false);
 
 // Simulate consultation request processing
 ...
 <div className="bg-white w-full max-w-lg rounded-2xl shadow-xl p-8 border-t-4 border-indigo-600">
 {/* Success message */}
 {submitSuccess && (
 <div className="mb-6 p-4 bg-emerald-100 text-emerald-700 rounded-lg flex items-center">
 ...
 description="Speak with our experienced attorneys about your legal needs."
...
const Gallery = ({
 ...
 id: 3,
 title: "Business Law", 
 description: "Strategic legal counsel for corporate and entrepreneurial needs",
 icon: null,
 category: "business"
 },
 {
 ...
 <div className="text-2xl font-bold">Pinnacle Legal Group</div>
 ...
 {/* Hero Section */}
 <header 
 className="min-h-[600px] bg-cover bg-center flex items-center justify-center text-center"
 style={{backgroundImage: "url('https://picsum.photos/seed/lawfirm/1920/1080')"}}
 >
 <div className="bg-black/50 absolute inset-0"></div>
 <div className="relative z-10 text-white px-6">
 <h1 className="text-5xl font-bold mb-4">Pinnacle Legal Group</h1>
 <p className="text-xl max-w-2xl mx-auto">
 Dedicated Legal Representation Tailored to Your Unique Needs
 </p>
 </div>
 </header>
 ...
 <div 
 key={area.id} 
 className="bg-white rounded-xl shadow-xl p-6 text-center hover:scale-105 transition-all duration-300"
 >
 ...
 <p>&copy; 2023 Pinnacle Legal Group. All Rights Reserved.</p>
 </div>
 </footer>
 </div>
 );
...
// ── Footer ──
const Footer = ({
 companyName = "Johnson & Williams Law Firm",
 description = "Experienced legal professionals dedicated to protecting your rights and achieving justice in every case.",
 sections = [
 {
 ...
 { label: "Business Litigation", href: "/services/business" },
 ...
 { label: "Case Results", href: "/resources/results" },
 { label: "Client Testimonials", href: "/resources/testimonials" },
 ...
 { 
 name: "Facebook", 
 href: "https://facebook.com/johnsonwilliamslaw", 
 ...
 { 
 name: "LinkedIn", 
 href: "https://linkedin.com/company/johnsonwilliamslaw", 
 icon: <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
 ...
 <h2 className="text-white text-2xl font-bold mb-4">Johnson & Williams Law Firm</h2>
 <p className="text-gray-400 mb-6 max-w-md">
 Committed to delivering exceptional legal representation with compassion, integrity, and expertise across multiple practice areas.
 </p>
 ...
 Subscribe to receive legal insights, firm updates, and important news.
 </p>
 </div>
 ...
 <button
 type="submit"
 className="px-6 py-2 bg-indigo-600 text-white font-medium rounded-lg hover:bg-indigo-700 transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 focus:ring-offset-gray-900"
 >
 ...
 © {copyrightYear} Johnson & Williams Law Firm. All rights reserved.
 </p>
