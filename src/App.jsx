    ...
    >
      ...
      <div className="relative z-10 text-center text-white px-4 max-w-4xl">
        ...
        <p className="text-xl md:text-2xl mb-8 opacity-90">
          We ensure your API integrations work flawlessly from end to end, so you can deploy with confidence every time.
        </p>
        <button
    ...
    <footer className="bg-gray-900 text-white py-12">
      <div className="max-w-6xl mx-auto px-4">
        <div className="text-center">
          ...
          <p className="text-gray-400 mb-6">Streamlined API validation for teams that demand reliability.</p>
...
const FAIBRIC_SESSION_TOKEN = "ba1e81188750f06612a49a81950d2996e2ac3f213096a6420a6dd7e2cd7de3a5";
