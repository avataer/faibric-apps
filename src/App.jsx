...
const Navigation = ({ currentView, onNavigate }) => {
  ...
  const navItems = [{"id": "curriculum", "label": "Curriculum"}, {"id": "features", "label": "Features"}, {"id": "testimonials", "label": "Parent Reviews"}, {"id": "pricing", "label": "Pricing"}, {"id": "free-trial", "label": "Free Trial"}];

  return (
    <nav className="bg-white shadow-md sticky top-0 z-50">
      <div className="max-w-7xl mx-auto px-4">
        <div className="flex justify-between items-center h-16">
          <span className="text-xl font-bold text-gray-900">LearnPlay</span>
...
const HeroSection = ({ onNavigate }) => {
  return (
    <section
      ...
      style={{backgroundImage: "url('https://picsum.photos/seed/children-learning/1920/1080')"}}
    >
      ...
      <div className="relative z-10 text-center text-white px-4 max-w-4xl">
        ...
        <p className="text-xl md:text-2xl mb-8 opacity-90">
          Watch your child discover reading, math, and creativity through interactive games designed by education experts for ages 3-8.
        </p>
        <button
...
const TestimonialsSection = () => {
  const testimonials = [{"quote": "My daughter begs to do her LearnPlay lessons every day. She went from struggling with letters to reading simple books in just three months. This app is pure magic.", "name": "Sarah Mitchell", "role": "Mother of Emma, age 5"}, {"quote": "As a former teacher, I am picky about educational apps. LearnPlay follows a real curriculum and makes learning genuinely fun. Worth every penny.", "name": "David Chen", "role": "Father of twins, age 4"}, {"quote": "The progress reports help me see exactly what skills my son is developing. He thinks he is just playing games, but his math skills have improved dramatically.", "name": "Jessica Rodriguez", "role": "Mother of Lucas, age 6"}, {"quote": "Finally an app with no ads and real educational value. My kids have learned more with LearnPlay in two months than with any other program we have tried.", "name": "Michael Thompson", "role": "Father of two, ages 4 and 7"}];

  return (
    <section className="py-20 px-4 bg-gradient-to-br from-slate-900 to-slate-800">
      <div className="max-w-6xl mx-auto">
        <h2 className="text-4xl font-bold text-center text-white mb-16">Loved by Parents, Adored by Kids</h2>
    ...
    <footer className="bg-gray-900 text-white py-12">
      <div className="max-w-6xl mx-auto px-4">
        <div className="text-center">
          <h3 className="text-2xl font-bold mb-2">LearnPlay</h3>
          <p className="text-gray-400 mb-6">Building bright futures through the power of play</p>
          <div className="border-t border-gray-800 pt-6">
            <p className="text-gray-500 text-sm">
              2024 LearnPlay. All rights reserved.
            </p>
...
const FAIBRIC_SESSION_TOKEN = "s7oZOrQqdsuYZ0-J5yaDZoO2dFcTAAgJ6rGdlpXsJas";
