...
const Navigation = ({ currentView, onNavigate }) => {
  ...
  const navItems = [{"id": "home", "label": "Home"}, {"id": "classes", "label": "Class Schedule"}, {"id": "membership", "label": "Membership"}, {"id": "trainers", "label": "Our Trainers"}, {"id": "about", "label": "About Us"}, {"id": "contact", "label": "Free Trial"}];

  return (
    <nav className="bg-white shadow-md sticky top-0 z-50">
      <div className="max-w-7xl mx-auto px-4">
        <div className="flex justify-between items-center h-16">
          <span className="text-xl font-bold text-gray-900">IronCore Gym</span>
    ...
    <section className="min-h-screen relative flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 text-center text-white px-6 max-w-4xl">
        ...
        <h1 className="text-5xl md:text-7xl font-bold mb-6 leading-tight">
          Forge Your Strongest Self at IronCore Gym
        </h1>
        <p className="text-xl md:text-2xl mb-10 opacity-90 max-w-2xl mx-auto">
          Transform your body and mind with expert-led classes, cutting-edge equipment, and a community that pushes you to achieve more.
        </p>
...
const FeaturesSection = () => {
  const features = [{"title": "Expert-Led Group Classes", "description": "From high-intensity interval training to yoga and strength conditioning, our diverse class schedule fits every fitness level and goal.", "icon_letter": "C"}, {"title": "State-of-the-Art Equipment", "description": "Train with premium machines, free weights, and functional training zones designed to maximize your workout efficiency.", "icon_letter": "E"}, {"title": "Certified Personal Trainers", "description": "Our nationally certified trainers create personalized programs and provide the motivation you need to break through plateaus.", "icon_letter": "T"}, {"title": "Flexible Membership Options", "description": "Choose from multiple membership tiers designed to match your lifestyle, budget, and fitness commitment level.", "icon_letter": "M"}];

  return (
    <section className="py-20 px-4 bg-gray-50">
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-16">
          <h2 className="text-4xl font-bold text-gray-900 mb-4">Why Choose IronCore Gym</h2>
          <p className="text-xl text-gray-600 max-w-2xl mx-auto">Everything you need to reach your fitness goals under one roof</p>
        </div>
...
const AboutSection = () => {
  const paragraphs = ["IronCore Gym was founded in 2015 with a simple mission: to create a fitness community where everyone from beginners to competitive athletes can thrive. We believe that true strength comes from consistency, proper guidance, and an environment that inspires you to push beyond your limits.", "Our 15,000 square foot facility features dedicated zones for cardio, strength training, functional fitness, and group classes. Every piece of equipment is carefully selected to provide safe, effective workouts that deliver real results.", "What sets IronCore apart is our people. Our trainers bring decades of combined experience in sports science, nutrition, and coaching. They are not just instructors but mentors who invest in your success and celebrate every milestone with you.", "Join thousands of members who have transformed their lives at IronCore Gym. Whether your goal is weight loss, muscle building, improved athletic performance, or simply better health, we have the tools and team to help you get there."];
    ...
    <section className="py-20 px-4">
      <div className="max-w-6xl mx-auto">
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div>
            <h2 className="text-4xl font-bold text-gray-900 mb-8">Built on Strength, Driven by Results</h2>
          ...
          <div className="relative">
            ...
            <img
              src="https://picsum.photos/seed/gym/800/600"
              alt="About us"
...
const ContactSection = () => {
  ...
  return (
    <section className="py-20 px-4 bg-gray-50">
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-16">
          <h2 className="text-4xl font-bold text-gray-900 mb-4">Start Your Free 7-Day Trial</h2>
          <p className="text-xl text-gray-600">Ready to experience IronCore Gym? Fill out the form below and one of our team members will contact you to schedule your complimentary trial week.</p>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-12">
          <div>
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              >
                {sending ? "Sending..." : "Claim Free Trial"}
              </button>
            </form>
          </div>
            ...
            <div>
              ...
              <div className="space-y-4 text-gray-600">
                ...
                <p className="flex items-center gap-3">
                  ...
                  2450 Iron Street, Suite 100, Riverside, CA 92501
                </p>
              </div>
            </div>
          </div>
    ...
    <footer className="bg-gray-900 text-white py-12">
      <div className="max-w-6xl mx-auto px-4">
        <div className="text-center">
          <h3 className="text-2xl font-bold mb-2">IronCore Gym</h3>
          <p className="text-gray-400 mb-6">Forge Your Strongest Self</p>
          <div className="border-t border-gray-800 pt-6">
            <p className="text-gray-500 text-sm">
              2024 IronCore Gym. All rights reserved.
            </p>
...
const FAIBRIC_SESSION_TOKEN = "0N52RgEBzn5t1ioxhJ1mkTQl_VEeSIF5RpnSKB_-AbA";
