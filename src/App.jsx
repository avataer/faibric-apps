    ...
    >
      ...
      <div className="relative z-10 text-center text-white px-4 max-w-4xl">
        ...
        <p className="text-xl md:text-2xl mb-8 opacity-90">
          We help development teams validate, monitor, and optimize their API pipelines with precision and confidence every single day.
        </p>
        <button
    ...
    <footer className="bg-gray-900 text-white py-12">
      <div className="max-w-6xl mx-auto px-4">
        <div className="text-center">
          ...
          <p className="text-gray-400 mb-6">Ensuring your API pipelines perform flawlessly from submission to delivery.</p>
...
const FAIBRIC_SESSION_TOKEN = "e9e709e3505b59e8cb456f88947d779632efef48bb52ddeea7326ff25618fcfd";
