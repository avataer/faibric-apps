  ...
  return (
    <section className="min-h-screen relative flex items-center justify-center overflow-hidden">
      <div
        ...
        style={{
          backgroundImage: "url('https://picsum.photos/seed/peaceful yoga practice in sunlit studio surrounded by green plants and natural light/1920/1080')",
      ...
      <div className="relative z-10 text-center text-white px-6 max-w-4xl">
        ...
        <p className="text-xl md:text-2xl mb-10 opacity-90 max-w-2xl mx-auto">
          Zen Flow Studio offers a sanctuary for body and mind, where thoughtful instruction meets tranquil spaces. Whether you are stepping onto the mat for the first time or deepening a lifelong practice, our studio is your place to breathe, move, and grow.
        </p>
...
const FeaturesSection = () => {
  const features = [{"title": "Nature-Inspired Studio Space", "description": "Our light-filled studio is designed with natural wood, living greenery, and floor-to-ceiling windows that bring the outdoors in. Every session feels like a retreat into nature.", "icon_letter": "N"}, {"title": "Expert-Led Instruction", "description": "Our certified instructors bring decades of combined experience across Vinyasa, Hatha, Yin, and Restorative yoga. Each class is crafted with intention, alignment cues, and mindful pacing.", "icon_letter": "E"}, {"title": "Classes for Every Level", "description": "From gentle beginner flows to advanced power sequences, we offer a diverse schedule that meets you exactly where you are. No experience necessary to begin.", "icon_letter": "C"}, {"title": "Holistic Community", "description": "More than a studio, Zen Flow is a community built on kindness, support, and shared growth. Join our workshops, retreats, and wellness events throughout the year.", "icon_letter": "H"}];
    ...
    <section className="py-20 px-4 bg-gray-50">
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-2xl mx-auto">At Zen Flow Studio, every detail is designed to nurture your well-being and support your journey toward balance.</p>
        </div>
...
const AboutSection = () => {
  const paragraphs = ["Zen Flow Studio was founded with a simple vision: to create a space where people can slow down, reconnect with themselves, and leave feeling more grounded than when they arrived. Nestled in a quiet neighborhood surrounded by natural beauty, our studio reflects the peace we hope to cultivate in every student who walks through our doors.", "Our founder, inspired by years of studying yoga traditions across India and Bali, wanted to bring an authentic yet accessible practice to the local community. Every element of Zen Flow, from the bamboo flooring to the curated essential oil blends that greet you at the entrance, has been chosen with care and purpose.", "We believe yoga is for every body. Our inclusive approach means you will never feel judged or out of place here. Whether you come for the physical benefits, the mental clarity, or simply a quiet hour in your busy week, Zen Flow Studio is honored to be part of your wellness journey."];
      ...
      <div className="max-w-6xl mx-auto">
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          <div className="relative">
            ...
            <img
              src="https://picsum.photos/seed/serene yoga studio interior with green plants natural wood and soft morning light streaming through windows/800/600"
              alt="About us"
    ...
    <section className="py-20 px-4 bg-gray-50">
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600">Have a question about our classes, pricing, or studio? We would love to hear from you. Send us a message and our team will respond within 24 hours.</p>
        </div>
            ...
            <div>
              ...
              <div className="space-y-4 text-gray-600">
                ...
                <p className="flex items-center gap-3">
                  ...
                  142 Willow Creek Lane, Suite 8, Portland, OR 97205
                </p>
              </div>
            </div>
          </div>
