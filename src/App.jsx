    ...
    <section className="min-h-screen relative flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 text-center text-white px-6 max-w-4xl">
        ...
        <p className="text-xl md:text-2xl mb-10 opacity-90 max-w-2xl mx-auto">
          Welcome to Zen Flow Studio, a sanctuary of stillness and movement nestled in nature. Our tranquil space and expert instructors guide you toward deeper mindfulness, renewed strength, and lasting inner peace.
        </p>
...
const FeaturesSection = () => {
  const features = [{"title": "Nature-Inspired Studio Space", "description": "Our studio is filled with natural light, living greenery, and sustainably sourced materials, creating a serene environment where your practice naturally deepens with every breath.", "icon_letter": "N"}, {"title": "Expert-Led Classes for Every Level", "description": "From gentle restorative sessions to dynamic vinyasa flows, our certified instructors offer personalized guidance so beginners and experienced yogis alike feel welcomed and challenged.", "icon_letter": "E"}, {"title": "Holistic Wellness Approach", "description": "We integrate breathwork, meditation, and mindful movement into every class, helping you cultivate a sustainable practice that extends well beyond the mat and into daily life.", "icon_letter": "H"}, {"title": "Supportive Community", "description": "Join a warm and inclusive community of like-minded individuals who encourage growth, celebrate progress, and share the journey toward greater well-being together.", "icon_letter": "S"}];
    ...
    <section className="py-20 px-4 bg-gray-50">
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-2xl mx-auto">At Zen Flow Studio, every detail is designed to nurture your body, calm your mind, and restore your spirit.</p>
        </div>
...
const AboutSection = () => {
  const paragraphs = ["Zen Flow Studio was born from a simple belief: that everyone deserves a peaceful space to reconnect with themselves. Founded in 2018 by lifelong yoga practitioner Maya Chen, our studio was designed to feel like stepping into a quiet forest clearing, where the noise of everyday life fades and inner stillness emerges.", "Our philosophy is rooted in the harmony between nature and movement. Every element of our space, from the bamboo flooring beneath your feet to the living plant walls that purify the air, has been thoughtfully chosen to support your practice and honor the natural world around us.", "Over the years, we have grown into a thriving community of over 500 dedicated practitioners. Whether you are unrolling your mat for the first time or deepening a decades-long practice, Zen Flow Studio is your home for mindful movement, authentic connection, and lasting transformation."];
      ...
      <div className="max-w-6xl mx-auto">
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          <div className="relative">
            ...
            <img
              src="https://picsum.photos/seed/tranquil yoga studio interior with green plants natural wood floors and soft natural lighting/800/600"
              alt="About us"
    ...
    <section className="py-20 px-4 bg-gray-50">
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600">Whether you have questions about our class schedule, want to book a private session, or simply want to learn more about Zen Flow Studio, we would love to hear from you.</p>
        </div>
            ...
            <div>
              ...
              <div className="space-y-4 text-gray-600">
                ...
                <p className="flex items-center gap-3">
                  ...
                  742 Evergreen Lane, Mill Valley, CA 94941
                </p>
              </div>
            </div>
          </div>
...
const FAIBRIC_SESSION_TOKEN = "7d94652ea9341e2b0837df2c31b2538fc77582ed3da31409d9d4b40018a3f3c8";
