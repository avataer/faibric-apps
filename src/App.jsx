...
const Navigation = ({ currentView, onNavigate }) => {
  ...
  const navItems = [{"id": "home", "label": "Home"}, {"id": "menu", "label": "Wine List"}, {"id": "about", "label": "About Us"}, {"id": "contact", "label": "Contact"}];

  return (
    <nav className="bg-gray-900 shadow-md sticky top-0 z-50">
      <div className="max-w-7xl mx-auto px-4">
        <div className="flex justify-between items-center h-16">
          <span className="text-xl font-bold text-amber-400">Evening Brew</span>
            ...
            {(navItems || []).map(item => (
              <button
                ...
                className={`block w-full text-left py-2 px-4 ${
                  currentView === item.id ? "text-amber-400 bg-gray-800" : "text-gray-300"
                }`}
              >
                {item.label}
              </button>
...
const HeroSection = ({ onNavigate }) => {
  return (
    <section
      ...
      style={{backgroundImage: "url('https://picsum.photos/seed/wine/1920/1080')"}}
    >
      <div className="absolute inset-0 bg-gradient-to-r from-black/80 via-black/60 to-purple-900/40"></div>
      <div className="relative z-10 text-center text-white px-4 max-w-4xl">
        <h1 className="text-5xl md:text-6xl font-bold mb-6 leading-tight">
          Unwind With The Perfect Glass
        </h1>
        <p className="text-xl md:text-2xl mb-8 opacity-90">
          Curated wines from the world's finest vineyards, served in an intimate and sophisticated atmosphere every evening.
        </p>
        <button
          onClick={() => onNavigate && onNavigate("contact")}
          className="px-8 py-4 bg-amber-500 text-gray-900 rounded-lg font-semibold text-lg hover:bg-amber-400 transition-all duration-300 shadow-xl hover:shadow-2xl transform hover:scale-105"
        >
          View Our Wine List
        </button>
      </div>
    ...
    <section className="py-20 px-4 bg-gray-800">
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-300">Have a question or want to book a private tasting? We would love to hear from you.</p>
        </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full p-3 border border-gray-600 bg-gray-700 text-white rounded-lg focus:ring-2 focus:ring-amber-500 focus:border-transparent transition"
                  required
                />
              </div>
              ...
              <div>
                ...
                <textarea
                  ...
                  rows="5"
                  className="w-full p-3 border border-gray-600 bg-gray-700 text-white rounded-lg focus:ring-2 focus:ring-amber-500 focus:border-transparent transition resize-none"
                  required
                ></textarea>
              </div>
              ...
              <button
                type="submit"
                disabled={sending}
                className="w-full py-4 bg-amber-500 text-gray-900 rounded-lg font-semibold hover:bg-amber-400 transition-colors disabled:bg-gray-500"
              >
            ...
            <div>
              ...
              <div className="space-y-4 text-gray-300">
                <p className="flex items-center gap-3">
                  <span className="w-10 h-10 bg-amber-500/20 rounded-full flex items-center justify-center">
                ...
                <p className="flex items-center gap-3">
                  ...
                  142 Maple Street, Downtown District
                </p>
              </div>
            </div>
          </div>
    ...
    <footer className="bg-black text-white py-12">
      <div className="max-w-6xl mx-auto px-4">
        <div className="text-center">
          <h3 className="text-2xl font-bold mb-2 text-amber-400">Evening Brew</h3>
          <p className="text-gray-400 mb-6">Curating the perfect pour since 2018</p>
          <div className="border-t border-gray-800 pt-6">
            <p className="text-gray-500 text-sm">
              2024 Evening Brew. All rights reserved.
            </p>
...
const FAIBRIC_SESSION_TOKEN = "SwAnjEepcuJyMKOHgW1uWn-w_WmxSilHwFbgljwy5CU";
const FAIBRIC_API_URL = "https://faibric-api.onrender.com";
const FAIBRIC_SITE_URL = "https://appkww8vgopwo-abpszk5vg-antons-projects-f1d70cf2.vercel.app";
