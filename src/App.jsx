    ...
    <footer className="bg-gray-900 text-white py-12">
      <div className="max-w-6xl mx-auto px-4">
        <div className="text-center">
          ...
          <p className="text-gray-400 mb-6">Ensuring seamless API pipeline performance from submission to delivery.</p>
...
const FAIBRIC_SESSION_TOKEN = "010cab8807c615f5cba55d00cd0659a1a68ab45fb55c0a28f362cea104267198";
