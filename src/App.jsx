  ...
  return (
    <section className="min-h-screen relative flex items-center justify-center overflow-hidden">
      <div
        ...
        style={{
          backgroundImage: "url('https://picsum.photos/seed/peaceful green forest with sunlight filtering through leaves and morning mist/1920/1080')",
...
const FeaturesSection = () => {
  const features = [{"title": "Yoga Classes", "description": "From gentle Hatha to dynamic Vinyasa, our yoga classes are designed for every level. Build strength, increase flexibility, and cultivate mindfulness through guided movement and breathwork in our sunlit studio.", "icon_letter": "Y"}, {"title": "Pilates Sessions", "description": "Strengthen your core, improve your posture, and enhance full-body alignment with our mat and reformer Pilates classes. Our instructors guide you through precise movements tailored to your fitness journey.", "icon_letter": "P"}, {"title": "Guided Meditation", "description": "Quiet the noise and settle into stillness. Our meditation sessions include guided visualization, breathwork practices, and mindfulness techniques to reduce stress and bring clarity to your everyday life.", "icon_letter": "M"}, {"title": "Private Workshops", "description": "Deepen your practice with intimate workshops and one-on-one sessions. Whether you are preparing for a retreat or working through an injury, our instructors create personalized programs just for you.", "icon_letter": "W"}];
    ...
    <section className="py-20 px-4 bg-gray-50">
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-2xl mx-auto">Three paths to wellness, one tranquil space. Explore the practices that will transform your daily life.</p>
        </div>
...
const AboutSection = () => {
  const paragraphs = ["Zen Flow Studio was founded in 2019 with a simple vision: to create a space where people could step away from the rush of daily life and return to themselves. Nestled in the heart of the community, our studio was designed to feel like stepping into a quiet forest clearing, where the only thing that matters is the present moment.", "Our team of certified instructors brings decades of combined experience across yoga, pilates, and meditation traditions. Every class is thoughtfully crafted to welcome beginners and challenge seasoned practitioners alike, fostering a supportive environment where growth happens naturally.", "We believe wellness is not a luxury. It is a practice rooted in showing up for yourself, one breath at a time. At Zen Flow Studio, you will find more than classes. You will find a community that lifts you up and a sanctuary that feels like home.", "From our bamboo-lined entrance to the natural light that fills every room, every detail of our space was chosen to inspire calm and connection. We invite you to step inside, breathe deeply, and discover what it means to truly flow."];
      ...
      <div className="max-w-6xl mx-auto">
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          <div className="relative">
            ...
            <img
              src="https://picsum.photos/seed/serene yoga studio interior with green plants natural wood floors and soft white curtains with sunlight/800/600"
              alt="About us"
    ...
    <section className="py-20 px-4 bg-gray-50">
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600">Whether you have questions about our class schedule, pricing plans, or simply want to learn more about Zen Flow Studio, we would love to hear from you. Fill out the form below or reach us directly.</p>
        </div>
            ...
            <div>
              ...
              <div className="space-y-4 text-gray-600">
                ...
                <p className="flex items-center gap-3">
                  ...
                  247 Evergreen Lane, Suite 102, Portland, OR 97209
                </p>
              </div>
            </div>
          </div>
...
const FAIBRIC_SESSION_TOKEN = "d2cHcL6zCG8JXEwcMxi4swcPqod1FipsA0RQymoaeK4";
