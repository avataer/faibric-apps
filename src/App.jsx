  ...
  return (
    <section className="min-h-screen relative flex items-center justify-center overflow-hidden">
      <div
        ...
        style={{
          backgroundImage: "url('https://picsum.photos/seed/peaceful yoga studio with green plants and natural light streaming through windows/1920/1080')",
      ...
      <div className="relative z-10 text-center text-white px-6 max-w-4xl">
        ...
        <p className="text-xl md:text-2xl mb-10 opacity-90 max-w-2xl mx-auto">
          Zen Flow Studio offers yoga, pilates, and meditation classes in a serene, nature-inspired space designed to help you reconnect with your body, breath, and inner peace.
        </p>
...
const FeaturesSection = () => {
  const features = [{"title": "Yoga Classes", "description": "Choose from Vinyasa, Hatha, Yin, and Restorative yoga sessions led by certified instructors. Whether you are a beginner seeking foundation or an experienced practitioner deepening your practice, our classes meet you where you are.", "icon_letter": "Y"}, {"title": "Pilates Sessions", "description": "Strengthen your core, improve posture, and build lean muscle through our mat and reformer pilates classes. Our sessions blend classical technique with modern movement science for a transformative workout.", "icon_letter": "P"}, {"title": "Guided Meditation", "description": "Cultivate mindfulness and inner stillness through our guided meditation sessions. From breathwork and body scans to loving-kindness practices, these classes help reduce stress and sharpen mental clarity.", "icon_letter": "M"}, {"title": "Private Instruction", "description": "Work one-on-one with our experienced instructors to develop a personalized practice tailored to your goals, injuries, or specific needs. Private sessions are available for yoga, pilates, and meditation.", "icon_letter": "I"}];
    ...
    <section className="py-20 px-4 bg-gray-50">
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-2xl mx-auto">From dynamic vinyasa flows to stillness in meditation, our classes nurture every dimension of your well-being.</p>
        </div>
...
const AboutSection = () => {
  const paragraphs = ["Zen Flow Studio was founded in 2019 with a simple vision: to create a sanctuary where people can slow down, breathe deeply, and move with intention. Nestled in a light-filled space surrounded by living greenery, our studio is designed to feel like stepping into nature itself.", "We believe that wellness is not a destination but a daily practice. Our team of dedicated instructors brings decades of combined experience in yoga, pilates, and meditation, and each one is passionate about guiding students of all levels toward greater strength, flexibility, and peace of mind.", "At Zen Flow, community matters. We foster an inclusive, judgment-free environment where every body is welcome. From your very first class, you will feel the warmth and support that makes our studio more than just a place to practice. It is a place to belong.", "Our studio features sustainably sourced bamboo flooring, air-purifying plants throughout, and natural aromatherapy diffused into every room. Every detail is intentional, creating a space that nurtures your practice from the moment you walk through the door."];
    ...
    <section className="py-20 px-4">
      <div className="max-w-6xl mx-auto">
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div>
            <h2 className="text-4xl font-bold text-gray-900 mb-8">About Zen Flow Studio</h2>
          ...
          <div className="relative">
            ...
            <img
              src="https://picsum.photos/seed/serene yoga studio interior with lush green plants, bamboo floors, and soft white walls with natural sunlight/800/600"
              alt="About us"
    ...
    <section className="py-20 px-4 bg-gray-50">
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600">Have a question about our classes, pricing, or studio? We would love to hear from you. Fill out the form below or reach us directly.</p>
        </div>
            ...
            <div>
              ...
              <div className="space-y-4 text-gray-600">
                ...
                <p className="flex items-center gap-3">
                  ...
                  245 Evergreen Lane, Suite 102, Portland, OR 97205
                </p>
              </div>
            </div>
          </div>
...
const FAIBRIC_SESSION_TOKEN = "XDvmA6E2AsnWzmlgiByGpi_i2e3ZgkO2IZqSM41WLHQ";
