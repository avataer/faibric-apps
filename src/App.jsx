...
const Navigation = ({ currentView, onNavigate }) => {
  ...
  const navItems = [{"id": "dashboard", "label": "Dashboard Preview"}, {"id": "features", "label": "Features"}, {"id": "pricing", "label": "Pricing"}, {"id": "demo", "label": "Request Demo"}];
    ...
    >
      ...
      <div className="relative z-10 text-center text-white px-4 max-w-4xl">
        ...
        <p className="text-xl md:text-2xl mb-8 opacity-90">
          DataPulse delivers real-time analytics dashboards that help you make smarter business decisions faster than ever before.
        </p>
        <button
...
const FeaturesSection = () => {
  const features = [{"title": "Real-Time Dashboards", "description": "Monitor your key metrics with live updating dashboards that refresh automatically. Customize views for every team member and stakeholder.", "icon_letter": "D"}, {"title": "Advanced Data Visualization", "description": "Transform complex datasets into clear, interactive charts and graphs. Choose from over 50 visualization types to tell your data story.", "icon_letter": "V"}, {"title": "Automated Reporting", "description": "Schedule and distribute reports automatically to stakeholders. Export in multiple formats including PDF, Excel, and interactive web links.", "icon_letter": "R"}, {"title": "Seamless Integrations", "description": "Connect with over 200 data sources including Salesforce, HubSpot, Google Analytics, and custom databases with our one-click integrations.", "icon_letter": "I"}];
    ...
    <section className="py-20 px-4 bg-gray-50">
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-2xl mx-auto">Everything you need to understand your data and drive growth</p>
        </div>
...
const TestimonialsSection = () => {
  const testimonials = [{"quote": "DataPulse transformed how our marketing team tracks campaign performance. We reduced reporting time by 80% and now make decisions based on real-time data instead of guesswork.", "name": "Sarah Mitchell", "role": "VP of Marketing at TechScale Inc."}, {"quote": "The dashboard customization is incredible. Each department has exactly the metrics they need, and our executives get a unified view of company performance at a glance.", "name": "James Chen", "role": "Director of Operations at Vertex Solutions"}, {"quote": "Implementation was seamless and the support team is exceptional. Within two weeks, we had all our data sources connected and actionable insights flowing to every stakeholder.", "name": "Maria Rodriguez", "role": "Head of Business Intelligence at CloudFirst"}];

  return (
    <section className="py-20 px-4 bg-gradient-to-br from-slate-900 to-slate-800">
      <div className="max-w-6xl mx-auto">
        <h2 className="text-4xl font-bold text-center text-white mb-16">Trusted by Data-Driven Teams</h2>
    ...
    <footer className="bg-gray-900 text-white py-12">
      <div className="max-w-6xl mx-auto px-4">
        <div className="text-center">
          <h3 className="text-2xl font-bold mb-2">DataPulse</h3>
          <p className="text-gray-400 mb-6">Empowering businesses with intelligent analytics</p>
...
const FAIBRIC_SESSION_TOKEN = "DOCvQLzJEjTn5ktsmBMsg33I9sAViIURtvxxqcNbjj0";
