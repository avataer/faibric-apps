...
const Navigation = ({ currentView, onNavigate }) => {
  ...
  const navItems = [{"id": "home", "label": "Home"}, {"id": "new-arrivals", "label": "New Arrivals"}, {"id": "shop", "label": "Shop Vinyl"}, {"id": "artists", "label": "Artist Spotlights"}, {"id": "about", "label": "About Us"}, {"id": "contact", "label": "Contact"}];

  return (
    <nav className="bg-white shadow-md sticky top-0 z-50">
      <div className="max-w-7xl mx-auto px-4">
        <div className="flex justify-between items-center h-16">
          <span className="text-xl font-bold text-gray-900">Groove Records</span>
...
const HeroSection = ({ onNavigate }) => {
  return (
    <section
      ...
      style={{backgroundImage: "url('https://picsum.photos/seed/vinyl-records/1920/1080')"}}
    >
      <div className="absolute inset-0 bg-gradient-to-r from-black/70 via-black/50 to-transparent"></div>
      <div className="relative z-10 text-center text-white px-4 max-w-4xl">
        <h1 className="text-5xl md:text-6xl font-bold mb-6 leading-tight">
          Discover the Sound of Authentic Vinyl
        </h1>
        <p className="text-xl md:text-2xl mb-8 opacity-90">
          Curated vintage records from the golden era of music. Rare finds, classic albums, and timeless grooves waiting for your turntable.
        </p>
        <button
    ...
    <footer className="bg-gray-900 text-white py-12">
      <div className="max-w-6xl mx-auto px-4">
        <div className="text-center">
          <h3 className="text-2xl font-bold mb-2">Groove Records</h3>
          <p className="text-gray-400 mb-6">Spinning classics since the days of disco. Your destination for authentic vintage vinyl.</p>
          <div className="border-t border-gray-800 pt-6">
            <p className="text-gray-500 text-sm">
              2024 Groove Records. All rights reserved.
            </p>
...
const FAIBRIC_SESSION_TOKEN = "Kh71SjF2W1s9xzjg1dD4mf3T1AY0dNp_AXOfegugYbg";
