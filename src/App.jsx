  ...
  return (
    <section className="min-h-screen relative flex items-center justify-center overflow-hidden">
      <div
        ...
        style={{
          backgroundImage: "url('https://picsum.photos/seed/peaceful yoga practice in nature with green plants and sunlight/1920/1080')",
      ...
      <div className="relative z-10 text-center text-white px-6 max-w-4xl">
        ...
        <h1 className="text-5xl md:text-7xl font-bold mb-6 leading-tight">
          Find Your Balance, Breathe Your Way Home
        </h1>
        <p className="text-xl md:text-2xl mb-10 opacity-90 max-w-2xl mx-auto">
          Welcome to Zen Flow Studio, where the rhythm of your breath meets the stillness of nature. Discover transformative yoga classes designed to nurture your body, calm your mind, and restore your spirit in our serene, nature-inspired sanctuary.
        </p>
...
const FeaturesSection = () => {
  const features = [{"title": "Nature-Inspired Studio Spaces", "description": "Our studios are designed with living green walls, natural wood floors, and floor-to-ceiling windows that flood every room with soft, natural light. Practice surrounded by the calming energy of nature.", "icon_letter": "N"}, {"title": "Expert-Led Classes for Every Level", "description": "From gentle restorative sessions to powerful vinyasa flows, our certified instructors offer thoughtfully structured classes that meet you exactly where you are on your yoga journey.", "icon_letter": "E"}, {"title": "Holistic Wellness Approach", "description": "Beyond the mat, we offer guided meditation, breathwork workshops, and seasonal wellness retreats that integrate body, mind, and spirit for lasting transformation.", "icon_letter": "H"}, {"title": "Welcoming Community", "description": "Join a warm, supportive community of like-minded individuals who share a commitment to personal growth, mindful living, and nurturing one another along the path.", "icon_letter": "W"}];

  return (
    <section className="py-20 px-4 bg-gray-50">
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-16">
          <h2 className="text-4xl font-bold text-gray-900 mb-4">Why Practice at Zen Flow Studio</h2>
          <p className="text-xl text-gray-600 max-w-2xl mx-auto">We cultivate a mindful space where every practitioner, from complete beginners to seasoned yogis, can deepen their practice and reconnect with inner peace.</p>
        </div>
...
const AboutSection = () => {
  const paragraphs = ["Zen Flow Studio was born from a simple yet profound belief: that everyone deserves a sanctuary where they can slow down, reconnect, and restore. Founded in 2018 by longtime yoga practitioner and wellness advocate Maya Greenfield, our studio was created to bridge the gap between the healing power of nature and the ancient wisdom of yoga.", "Nestled in the heart of the community, our space reflects the tranquility of the natural world. Every design choice, from the living plant walls to the earthy, organic materials throughout, was made with intention. We believe your surroundings shape your practice, and we have crafted an environment that invites stillness the moment you step through our doors.", "Over the years, Zen Flow Studio has grown into more than a place to practice yoga. It is a gathering place for seekers, healers, and anyone looking to cultivate more peace in their daily lives. Our team of dedicated instructors brings diverse training backgrounds and a shared passion for making yoga accessible, inclusive, and deeply nourishing.", "Whether you are unrolling your mat for the first time or returning to a lifelong practice, we welcome you with open arms. At Zen Flow Studio, your journey inward begins here."];
      ...
      <div className="max-w-6xl mx-auto">
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          <div className="relative">
            ...
            <img
              src="https://picsum.photos/seed/serene yoga studio interior with green plants natural light wooden floors peaceful atmosphere/800/600"
              alt="About us"
    ...
    <section className="py-20 px-4 bg-gray-50">
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600">Whether you have questions about our class schedule, want to learn more about membership options, or simply wish to say hello, we would love to hear from you. Reach out and take the first step toward your practice.</p>
        </div>
            ...
            <div>
              ...
              <div className="space-y-4 text-gray-600">
                ...
                <p className="flex items-center gap-3">
                  ...
                  742 Willow Creek Lane, Suite 100, Portland, OR 97205
                </p>
              </div>
            </div>
          </div>
    ...
    <footer className="bg-gray-900 text-white py-12">
      <div className="max-w-6xl mx-auto px-4">
        <div className="text-center">
          ...
          <p className="text-gray-400 mb-6">Rooted in nature. Flowing with intention. Your sanctuary for mindful movement and inner peace.</p>
...
const FAIBRIC_SESSION_TOKEN = "ff0ccc19c7d916fdc774ee50a8a2d4330156598f614f34c6563c94881bc342d4";
