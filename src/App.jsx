...
const Navigation = ({ currentView, onNavigate }) => {
  ...
  const navItems = [{"id": "features", "label": "Features"}, {"id": "pricing", "label": "Pricing"}, {"id": "how-it-works", "label": "How It Works"}, {"id": "support", "label": "Support"}];

  return (
    <nav className="bg-white shadow-md sticky top-0 z-50">
      <div className="max-w-7xl mx-auto px-4">
        <div className="flex justify-between items-center h-16">
          <span className="text-xl font-bold text-gray-900">TaskVault</span>
...
const HeroSection = ({ onNavigate }) => {
  return (
    <section
      ...
      style={{backgroundImage: "url('https://picsum.photos/seed/productivity/1920/1080')"}}
    >
      ...
      <div className="relative z-10 text-center text-white px-4 max-w-4xl">
        ...
        <p className="text-xl md:text-2xl mb-8 opacity-90">
          TaskVault helps you capture, organize, and complete your tasks with secure cloud storage that keeps your to-do list accessible anywhere.
        </p>
        <button
    ...
    <footer className="bg-gray-900 text-white py-12">
      <div className="max-w-6xl mx-auto px-4">
        <div className="text-center">
          <h3 className="text-2xl font-bold mb-2">TaskVault</h3>
          <p className="text-gray-400 mb-6">Your tasks, securely stored and always within reach.</p>
          <div className="border-t border-gray-800 pt-6">
            <p className="text-gray-500 text-sm">
              2024 TaskVault. All rights reserved.
            </p>
...
const FAIBRIC_SESSION_TOKEN = "narLvS-es9SVeFk41qOO5WSvWTkvKEMtwehxhExmrbw";
